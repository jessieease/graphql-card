...
var TopBar = /** @class */ (function (_super) {
    ...
    function TopBar() {
        ...
        _this.getCurl = function () {
            ...
            var headers = __assign(__assign({ 'Accept-Encoding': 'gzip, deflate, br', 'Content-Type': 'application/json', Accept: 'application/json', Connection: 'keep-alive', DNT: '1', Origin: location.origin || session.endpoint }, globalHeaders), sessionHeaders);
